...
def test_get_pure_ratings_single_rating_with_watch():
    assert rtg.get_pure_ratings("AA+ *+") == "AA+"


def test_get_pure_ratings_single_rating_with_unsolicited_lowercase_u():
    assert rtg.get_pure_ratings("AA+u") == "AA+"


def test_get_pure_ratings_single_rating_with_unsolicited_uppercase_u():
    assert rtg.get_pure_ratings("AA+U") == "AA+"
...
def test_get_pure_ratings_series(rating_provider, rating_series, rating_series_clean):
...
def test_get_pure_ratings_series_with_nan():
...
def test_get_pure_ratings_dataframe():
...
def test_get_pure_ratings_dataframe_with_nan():
